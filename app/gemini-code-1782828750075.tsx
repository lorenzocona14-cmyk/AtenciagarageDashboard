...
const supabaseUrl = process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://qxxnhgftotmvimuxrprz.supabase.co';
const supabaseKey = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InF4eG5oZ2Z0b3RtdmltdXhycHJ6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODI3OTY1NjMsImV4cCI6MjA5ODM3MjU2M30.RI29VEfftx_GnNTdF0DTcbSNMSs8EDI2JwXhv2qQJRo';
...
export default function Dashboard() {
  ...
  const fetchMetrics = async () => {
    ...
    // 1. Turnos Lavadero Hoy
    const { count: countTurnos } = await supabase
      .from('lavadero_turnos')
      .select('*', { count: 'exact', head: true })
      .gte('created_at', todayIso);
    
    // 2. Clientes Encontrados Hoy (Sumamos los lotes de Apify)
  ...
  useEffect(() => {
    ...
    // Suscripciones Realtime para actualizar la UI sin recargar
